...
export type LiteralDecimalFloat = ParseRule<RuleType.LiteralFloatDecimal, [
  "/0[fh]/",
  "/[1-9][0-9]*[fh]/",
  "/[0-9]*\.[0-9]+([eE][+-]?[0-9]+)?[fh]?/",
  "/[0-9]+\.[0-9]*([eE][+-]?[0-9]+)?[fh]?/",
...
export type LiteralFloatHex = ParseRule<RuleType.LiteralFloatHex, [
...
export type LiteralFloat = ParseRule<RuleType.LiteralFloat, [
